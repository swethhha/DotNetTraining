...
namespace BugTrack.Application.Services
{
    public class BugService : IBugService
    {
        ...
        public async Task AddBugAsync(BugResquestDTO resquest)
        {
            var newBug = new Bug
            {
                Title = resquest.Title,
            ...
            await _bugRepository.AddAsync(newBug);
            await _bugRepository.SaveChangesAsync();
        }

        public async Task UpdateBugAsync(int id, BugResquestDTO resquest)
        {
            ...
            await _bugRepository.UpdateAsync(existingBug);
            await _bugRepository.SaveChangesAsync();
        }
